...
import { cleanViewerId, isPlainCandidate } from "@/lib/broadcast";
...
export async function POST(request: NextRequest) {
  ...
  if (!payload.sessionId || !viewerId || !isPlainCandidate(payload.candidate)) {
  ...
  await BroadcastPeer.updateOne(
    ...
    {
      $push: { broadcasterCandidates: payload.candidate },
